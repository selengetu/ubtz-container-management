...
@section('main_container')
    <div class="row">
        <div class="col-md-2" > <!-- XAILT-->
            ...
            <button class="btn btn-block" style="background-color: #a4294a; border-color:#a4294a;color:white" onclick="window.location='{{ url("department") }}'">Байгууллага бүртгэх</button>
